        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div
              ...
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Qendra
            </div>
            <div
              key={"Tirana"}
            ...
            <div
              ...
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Aktash
            </div>
            <div
              key={"Podgorica"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Qafa
            </div>
            <div
              key={"Saranda"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Rruga B
            </div>
            <div
              key={"Shkoder"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Rruga C
            </div>
            <div
              key={"Durres"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Ulpianë
            </div>
            <div
              key={"Prizren"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Bregu i Diellit
            </div>
            <div
              key={"Peja"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Lakrishte
            </div>
            <div
              key={"Gjakova"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Kalabria
            </div>
            <div
              key={"Budva"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Lagja e Muhaxherëve
            </div>
            <div
              key={"Ulcinj"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Tasligje
            </div>
            <div
              key={"Thessaloniki"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Mati 1
            </div>
            <div
              key={"Zagreb"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Mati 2
            </div>
            <div
              key={"Munich"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Kodra e Diellit
            </div>
            <div
              key={"Zürich"}
              className="bg-white/90 rounded-xl shadow px-3 py-4 flex items-center justify-center text-base font-medium text-gray-700 hover:bg-orange-50 hover:scale-105 transition-all duration-200 border border-orange-100"
              style={{ minHeight: 48 }}
            >
              <span className="mr-2 text-orange-500 text-lg">🚌</span> Veternik
            </div>
          </div>
        </div>
      </section>
