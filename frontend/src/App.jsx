...
const Menaxhimi = lazy(() => import("./components/Menaxhimi"));
const PageLoader = () => (
...
function App() {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      // setPage("dashboard"); // Mund ta komentosh nëse dëshiron të qëndrosh te faqja e menaxhimit pas refresh
    }
  }, []);
    ...
    <div>
      ...
      <div className="max-w-6xl mx-auto mt-10 px-6 min-h-[calc(100vh-340px)]">
        <Suspense fallback={<PageLoader />}>
          ...
          {/* SHTUAR: Faqja e re për CRUD-in e Ligjëruesve */}
